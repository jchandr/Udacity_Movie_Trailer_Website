...
If the code throws your a Message "Connection Error. Check the API Key", please contact me to get a new API key. After getting the new API Key, please paste it as the value for the variable "API_KEY" present in the python file "entertainment_center.py".
For Example,
